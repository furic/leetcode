<h2><a href="https://leetcode.com/problems/minimum-operations-to-equalize-subarrays">3762. Minimum Operations to Equalize Subarrays</a></h2><h3>Hard</h3><hr><p>You are given an integer array <code>nums</code> and an integer <code>k</code>.</p>
